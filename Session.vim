...
nnoremap <silent> h :execute 'silent! tabmove ' . (tabpagenr()-2)
nnoremap <silent> l :execute 'silent! tabmove ' . tabpagenr()
vnoremap   za
nnoremap   za
...
map ,t :tabs
map ,f :setlocal foldmethod=indent
map H gT
map L gt
nnoremap N Nzz
noremap Q <Nop>
...
map <F9> :cw|set invmodifiable|set invnumber
map <F8> :!php -l %
map <F6> :set invwrap|set wrap?
nmap <F5> :set invpaste|set paste?
map <F4> :TagbarToggle
map <F3> :qa
